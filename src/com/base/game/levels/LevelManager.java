...
public class LevelManager {
    ...
    public void loadLevels() {
        ...
        if (!loadTestLevel) {
            player = new Player(Display.getWidth() / 2 - 30, Display.getHeight() / 2 - 30, 41, 82,  4f, 20, 5);

            EmptyLevel level1 = new EmptyLevel("res/assets/levelBack.png", Display.getWidth(), Display.getHeight(), player, true);

            Boss boss = new Boss(Display.getWidth() / 2 - 35, Display.getHeight() - 250, 150, 200, 3f, 60, 8);
            BossLevel level2 = new BossLevel("res/assets/bossBack.png", Display.getWidth(), Display.getHeight(), boss, player, "res/scripts/cutsceneTest1.bsh");

            EmptyLevel endGame = new EmptyLevel("res/assets/thankYouForWatching.png", Display.getWidth(), Display.getHeight(), player, false);
