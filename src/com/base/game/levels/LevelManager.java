...
public class LevelManager {
    ...
    public void loadLevels() {
        ...
        if (!loadTestLevel) {
            ...
            Boss168 boss168 = new Boss168(Display.getWidth() / 2 - 35, Display.getHeight() - 250, 1, 170, 222, "res/assets/gibboWhite.png", 3f,60, 8);
            BossLevel level2 = new BossLevel("res/assets/classroom.png", 1280, 960, boss168, player, "res/scripts/eecs168Script.bsh");

            Boss268 boss268 = new Boss268(Display.getWidth() / 2 - 35, Display.getHeight() - 250, 1, 170, 222, "res/assets/gibboWhite.png", 3f,100, 8);
            ...
            Boss368 boss368 = new Boss368(Display.getWidth() / 2 - 35, Display.getHeight() - 250, 1, 190, 200, "res/assets/klineWhite.png", 3f,100, 8);
